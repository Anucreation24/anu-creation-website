    ...
    <section className="relative py-24 overflow-hidden bg-[#080808]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 text-center">
        <motion.h2
          ...
          className="font-[family-name:var(--font-cormorant)] text-4xl sm:text-5xl lg:text-6xl font-light text-[#F5F2EA] leading-[1.1] mb-4"
        >
          Commission Your
          <br />
          <span className="gold-text font-medium italic">Perfect Piece</span>
        </motion.h2>
        ...
        <motion.p
          ...
          className="font-[family-name:var(--font-inter)] text-[#B7B1A3] text-sm leading-relaxed max-w-sm mx-auto mb-9"
        >
          Every product is made to order. Reach out and let&apos;s craft
          something bespoke together.
        </motion.p>
